...
namespace Blockcore.Wallet.ViewModels
{
    public class DialogDemoViewModel : ViewModelBase
    {
        ...
        private async IAsyncEnumerable<string> Dialog1()
        {
            ...
            {
                ContentHeader = "Welcome to Blockcore Wallet",
                SupportingText = "Enjoy!",
        ...
        private async IAsyncEnumerable<string> Dialog4()
        {
            ...
            await using var icon = assets?.Open(new Uri("avares://Blockcore.Wallet/Assets/avalonia-logo.png"));
            
            var dialog = DialogHelper.CreateAlertDialog(new AlertDialogBuilderParams
            {
                ContentHeader = "Welcome to Blockcore Wallet",
                SupportingText = "Enjoy it!",
                StartupLocation = WindowStartupLocation.CenterOwner, 
                Borderless = true,
